...
Returns:
    the number of points the player has accumulated so far
...
Returns:
    the number of lives that the aliens have left
...
Returns:
    the number of lives that the humans have left
...
Returns:
    deletes the laser and human it collided with if there is a collision, and if there isn't, 1 will be added to the human laser index and the human index
...
Returns:
    deletes the laser and alien it collided with if there is a collision, and if there isn't, 1 will be added to the alien laser index and the alien index
...
Returns:
    deletes the laser and shooting star it collided with if there is a collision, and if there isn't, 1 will be added to the human laser index and the human shooting star index
...
Returns:
    deletes the laser and shooting star it collided with if there is a collision, and if there isn't, 1 will be added to the human laser index and the alien shooting star index
...
Returns:
    if run game is true, everything in the game will be drawn out and the game will run normally
...
Arguments:
    ...
    modifiers {str} -- allows the key pressed commands to be accessed 
...
def setup():
""""what will happen beofre the code is executed 

Returns:
    the arcade windown is drawn, key press and key release is paired with the keys on the keyboard
"""
