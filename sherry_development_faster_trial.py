...
human_x_positions = [random.randrange(WIDTH/2 + 25, WIDTH)]
human_y_positions = [random.randrange(HEIGHT, HEIGHT*2)]
alien_x_positions = [random.randrange(0, WIDTH/2 - 25)]
alien_y_positions = [random.randrange(HEIGHT, HEIGHT*2)]
