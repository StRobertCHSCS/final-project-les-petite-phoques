...
def draw_human(x, y):
    ...
    arcade.draw_rectangle_filled(x, y - 65, 80, 10, arcade.color.LIGHT_BLUE, -90)
    arcade.draw_rectangle_filled(x + 22, y - 120, 60, 5, arcade.color.LIGHT_BLUE, -45)
    arcade.draw_rectangle_filled(x - 22, y - 120, 60, 5, arcade.color.LIGHT_BLUE, 45)
    arcade.draw_rectangle_filled(x + 23, y - 80, 60, 5, arcade.color.LIGHT_BLUE, -20)
    arcade.draw_rectangle_filled(x + 23, y - 60, 60, 5, arcade.color.LIGHT_BLUE, 20)
