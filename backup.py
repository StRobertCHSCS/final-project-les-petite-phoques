...
def meteor_spaceship_collision():
    ...
    global meteor_width, meteor_height
    ...
    for x_meteor, y_meteor in zip(meteor_x_positions, meteor_y_positions):
        ...
        if (x_meteor - meteor_width/2 <= spaceship_human_x <= x_meteor + meteor_width/2 ) and (y_meteor - meteor_height/2 <= spaceship_human_y <= y_meteor + meteor_height/2 ):
